...
mod ffi {
    unsafe extern "C++" {
        ...
        fn open_trace(self: Pin<&mut Counter>, path: &str) -> bool;

        /// Flushes and closes the waveform trace.
        fn close_trace(self: Pin<&mut Counter>);

        /// Returns whether the waveform trace is open.
        fn trace_is_open(self: &Counter) -> bool;
